<?php
  ...
  if (!empty($_POST['email_admin']) && !empty($_POST['password']) && !empty($_POST['confirm_password'])) {
    
      if($_POST['password'] == $_POST['confirm_password']){
        $email = $_POST['email_admin'];
        $password = password_hash($_POST['password'], PASSWORD_BCRYPT);
        $query = "INSERT INTO registro_administrador (email,password) VALUES ('$email','$password')";
        ...
        <div class="my-container">
          <div class="form2">
            <form action="registro_administrador.php" method="POST">
              ...
              <p> <?= $message3 ?></p>
              <?php endif; ?></font>
              <input name="email_admin" type=text placeholder="Ingrese su correo:" value = "<?php if(isset($_POST['email']) && !$message2) echo $_POST['email'] ?>">
              ...
              <a href="login_administrador.php">Inicie sesión </a> aqui</p>
            </form>
          </div>
