...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Funciones del Administrador</title>
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <a href="FuncionesAdministrativo/interfaz_subir_planaDocente.php" class="selected">
        <div class="option">
      ...
      <a href="FuncionesAdministrativo/interfaz_subir_planaDirectiva.php" class="selected">
        <div class="option">
