...
<br>
 ...
 <div class="row">
 <div class="col-md-7">
      <form action="subir_planaDocente.php" method="POST" enctype="multipart/form-data"/>
        <div class="file-input text-center">
            <input  type="file" name="subir_planaDocente" id="file-input" class="file-input__input"/>
  ...
  $sqlCarga = ("SELECT nombres_apellidos_docente,email,dni FROM tdocentes ORDER BY id ASC");
      ...
      <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $data['nombres_apellidos_docente']; ?></td>
